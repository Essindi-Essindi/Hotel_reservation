    ...
    <aside class="sidebar" [class.collapsed]="collapsed">
      ...
      <div class="sidebar-header">
        ...
        <div class="logo-text" *ngIf="!collapsed">
          <span class="brand-name">Wardiere</span>
          <span class="brand-sub">Hotel Admin</span>
        </div>
      </div>

      <!-- Toggle button (extracted from admin.html toggle-btn pattern) -->
      <button class="toggle-btn" (click)="toggleCollapse.emit()" [attr.aria-label]="collapsed ? 'Expand sidebar' : 'Collapse sidebar'">
      ...
      <div class="sidebar-footer">
        <div class="footer-card" *ngIf="!collapsed">
          <p class="footer-brand">Wardiere Inc.</p>
